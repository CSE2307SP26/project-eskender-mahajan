...
public class CustomerMenu {
    ...
    public void displayWhichAccount() {
        ...
        System.out.println("6. Apply for a mortgage");
    ...
    public void applyForMortgage() {
        ...
        customer.applyForMortgage(amount, years);
        bankadmin.addMortgageApplication(customer.getMortgageApplications()
                .get(customer.getMortgageApplications().size() - 1));
        System.out.println("Mortgage application submitted!");
    }
